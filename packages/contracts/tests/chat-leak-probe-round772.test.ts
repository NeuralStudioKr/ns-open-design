...
describe("chat leak / persist probe round 772 (calc px minus)", () => {
  it("binds calc(10px + 5px - 2px) and leaves thinner unbound", () => {
    const html = [
      '<style data-od-official-look-css>.info-card{border:1px solid var(--border)}</style>',
      '<section class="slide" style="width:1920px;height:1080px">',
      '<span style="padding:calc(10px + 5px - 2px);border:1px solid tomato">ok</span>',
