...
describe("chat leak / persist probe round 515 (set84–88 closure)", () => {
  it("rem+em / FOO triangles / invent-frame", () => {
    const kitHtml = [
      '<style data-od-official-look-css>.info-card{border:1px solid var(--border)}</style>',
      '<section class="slide" style="width:1920px;height:1080px">',
      '<span style="padding:calc(0.5rem + 0.25em);border:1px solid navy">a</span>',
      '<p style="padding:calc(0.5rem + 4px);border:1px solid teal">b</p>',
      '<span style="padding:calc(0.4rem + 0.2em);border:1px solid tomato">thin</span>',
