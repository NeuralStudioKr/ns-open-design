...
describe("chat leak / persist probe round 339 (invent-frame keep + FOO)", () => {
  it("keeps invent-frame off flow and drops FOO chrome", () => {
    const html = [
      '<section class="slide" style="-moz-text-emphasis:none;-webkit-box-flex-group:1;box-shadow:0 0 0 1px red;border-top:1px solid navy;background-color:snow;width:1920px;height:1080px">',
      "<div>x</div>",
      "</section>",
    ].join("");
