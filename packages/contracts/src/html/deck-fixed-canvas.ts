...
const EXPLICIT_PAINT_COLOR_RE =
  /#(?:[0-9a-f]{3,8})\b|\b(?:rgba?|hsla?|oklch|oklab|lch|lab|color-mix|color)\s*\(|\b(?:navy|royalblue|mediumblue|indigo|skyblue|teal|cyan|blue|darkblue|purple|violet|fuchsia|magenta|crimson|emerald|amber|lime|rose|orange|pink)\b/i;
