...
export const ARTIFACT_ORPHAN_LINK_ATTR_LEAK_RE =
  /(?:^|>)\s*(?:href\s*=\s*["']https?:\/\/[^"']*(?:fonts\.googleapis|fonts\.gstatic|jsdelivr|unpkg|cdnjs|fonts\.bunny|fontshare|typekit|fontawesome)[^"']*["']\s*)?(?:rel\s*=\s*["'](?:stylesheet|preconnect|preload)["']\s*)+(?:crossorigin(?:\s*=\s*["'][^"']*["'])?\s*)?\/?>\s*/gim;
