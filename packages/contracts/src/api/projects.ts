...
export interface ProjectMetadata {
  ...
  templateClonedDeckSeeded?: boolean;
  templateCloneContentFillPending?: boolean;
  templateCloneContentFilled?: boolean;
  templateCloneFillMode?: 'prompt' | 'prompt-fill' | 'deterministic';
  /** 루프535 — ProjectView should observe + maybe sparse-repair once after deterministic persist. */
  templateCloneSparseCheckPending?: boolean;
