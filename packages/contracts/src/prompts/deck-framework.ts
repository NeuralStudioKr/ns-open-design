...
Rules:
1. On deck-delivery turns, first emit exactly one brief-specific Korean status sentence, then start the artifact immediately. Do not use a generic promise-only line. On quick-brief/question-form turns, do not emit an artifact.
