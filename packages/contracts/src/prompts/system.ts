...
**Turn 2+ (after \`[form answers — discovery]\` or a follow-up edit request):** your successful response is one short user-visible status sentence tailored to the brief in UI locale, followed by **exactly one** streaming artifact:
...
Your successful response is one short user-visible status sentence tailored to the brief in UI locale, followed by **exactly one** streaming artifact in this same turn:
