...
import { resolveTeamverMiniMaxApiKeyFromEnv } from './minimax-runtime.js';
...
export function resolveProxyStreamApiKeyDetailed(
  ...
  const provider: ManagedProviderId = opts?.provider ?? 'anthropic';
