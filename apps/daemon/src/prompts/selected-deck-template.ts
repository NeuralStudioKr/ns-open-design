...
export function wrapSelectedDeckTemplateSkillBody(
  ...
  return [
    ...
    '',
    'Content quality bar: every non-divider slide must have a headline, a takeaway,',
    'and concrete supporting content such as specific bullets, metrics, examples,',
    'risks, actions, timeline steps, comparison rows, or decision criteria.',
    'Do not ship the raw user prompt, template demo captions, or generic placeholder',
    'copy as slide content. Use varied slide roles/layouts and the full 1920×1080',
    'canvas intentionally; a deck that merely looks like a template thumbnail but',
    'has weak substance is still a failed deliverable.',
    '',
