...
export const zhCN: Dict = {
  ...
  'homeWorkingDir.hint': '让 Agent 可读取该本地目录（不会导入到项目文件）',
  ...
  'chat.conversationsSearchPlaceholder': '搜索对话',
  'chat.conversationsNoMatch': '没有匹配的对话。',
  ...
  'chat.startHintComposerOnly': '请在下方输入框描述你想生成的内容。',
  ...
  'chat.plusMenu.searchPlugins': '搜索插件…',
  'chat.plusMenu.searchMcp': '搜索 MCP…',
  'chat.plusMenu.searchSkills': '搜索技能…',
  'chat.plusMenu.pluginSourceAria': '插件来源',
  'chat.plusMenu.pluginsMine': '我的插件',
  'chat.plusMenu.mcpTemplates': '模板',
  ...
  'chat.mentionTabFiles': '文件',
  'chat.mentionNoResults': '没有找到“{query}”的结果。',
  'chat.mentionSearchPrompt': '搜索文件、标签页、插件、技能、MCP 服务器和连接器。',
  ...
  'preview.replicateContent': '以此设计开始',
  'preview.replicateContentDesc': '加载示例提示词，生成与预览相近的内容',
  ...
  'workspace.designFilesLink': '项目文件',
  ...
  'manualEdit.positionPromoteOnDrag': '拖动可在流式布局中偏移此元素。',
  'manualEdit.positionPromoteStickyOnDrag': '拖动可将此 sticky 元素设为 absolute 并移动。',
  ...
  'manualEdit.undo': '撤销',
  'manualEdit.redo': '重做',
  'fileRevision.history.title': '编辑历史',
  'fileRevision.history.empty': '尚无已保存的编辑。',
  'fileRevision.history.restore': '恢复',
  ...
  'fileRevision.history.retentionPending': '正在清理较早的编辑记录，列表将很快刷新。',
  ...
  'teamver.canvasSlideLaunch.stepOptionalBadge': '可选',
