...
export const ko: Dict = {
  ...
  'teamver.embed.designHome': 'Design 홈',
  'teamver.embed.designHomeTitle': 'Design 홈으로 — 프로젝트 목록·새 슬라이드',
  'teamver.embed.teamverApp': 'Teamver 앱',
  'teamver.embed.teamverAppTitle': 'Teamver 앱 열기 (Design에서 나가기)',
  'teamver.embed.sessionLoading': 'Teamver 세션 확인 중…',
  'teamver.embed.signIn': 'Teamver 로그인',
  'teamver.embed.designDisabled': 'Design 사용 불가',
  ...
  'teamver.driveImport.error.od_daemon_import_failed': 'Design 프로젝트에 저장할 수 없습니다',
