...
export const ko: Dict = {
  ...
  'teamver.homeCreate.lead': '내용과 스타일만 고르면 덱을 시작합니다.',
  ...
  'teamver.homeCreate.selectedTemplate': '스타일',
  'teamver.homeCreate.defaultTemplate': '기본 슬라이드 템플릿',
  'teamver.homeCreate.changeTemplate': '변경',
  ...
  'teamver.canvasSlideLaunch.stepTemplate': '슬라이드 템플릿',
