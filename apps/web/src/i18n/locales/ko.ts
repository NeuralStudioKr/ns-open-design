...
export const ko: Dict = {
  ...
  'common.exportPdf': 'PDF로 다운로드',
  'common.exportZip': '.zip으로 다운로드',
  'common.exportHtml': '독립 실행형 HTML로 다운로드',
  'common.exportImage': '이미지로 다운로드',
  ...
  'homeHero.placeholderTemplate': '만들고 싶은 내용을 적어 주세요 — {title} 템플릿이 스타일과 구조를 적용합니다',
  'homeHero.presetSelectedHint': '{title} 템플릿의 스타일·레퍼런스가 적용됩니다. 위 입력창에 요청을 작성하세요.',
  'homeHero.skills': '스킬',
  ...
  'homeWorkingDir.hint': '에이전트가 이 로컬 폴더를 읽게 합니다 (프로젝트 파일로 가져오지는 않음)',
  ...
  'designSystemPicker.previewUnavailable': '이 디자인 시스템에는 별도 미리보기 페이지가 없습니다.',
  'designSystemPicker.previewLoadFailed': '미리보기를 불러오지 못했습니다. 위 색상·요약을 참고하거나 잠시 후 다시 시도해 주세요.',
  'designSystemPicker.previewRetry': '다시 시도',
  ...
  'pluginCard.use': '사용',
  'pluginCard.useWithQuery': '예시 문구 불러오기',
  ...
  'examples.exportPdfAllSlides': 'PDF로 다운로드 (모든 슬라이드)',
  'examples.exportPptxLocked': 'PPTX로 다운로드… (템플릿을 먼저 여세요)',
  ...
  'chat.conversationsNoMatch': '일치하는 대화가 없습니다.',
  ...
  'chat.startHintComposerOnly': '아래 입력창에 만들고 싶은 내용을 적어 주세요.',
  ...
  'chat.designArtifactsShowMore': '파일 {count}개 더 보기',
  ...
  'chat.designToolbox.searchPlaceholder': '스킬 / MCP / 플러그인 / 커넥터 / 파일 검색...',
  'chat.plusMenu.searchPlugins': '플러그인 검색…',
  'chat.plusMenu.searchMcp': 'MCP 검색…',
  'chat.plusMenu.searchSkills': '스킬 검색…',
  'chat.plusMenu.pluginSourceAria': '플러그인 출처',
  'chat.plusMenu.pluginsMine': '내 플러그인',
  'chat.plusMenu.mcpTemplates': '템플릿',
  ...
  'chat.designToolbox.kind.designFile': '파일',
  'chat.designToolbox.context.browser': '브라우저',
  'chat.designToolbox.context.designFiles': '파일',
  ...
  'chat.designToolbox.prompt.contextGeneric': '현재 대상: 현재 열려 있는 HTML / 프로젝트 파일 / 웹 요소.',
  ...
  'chat.designToolbox.prompt.noSkill': '특정 skill이 일치하지 않으면, 먼저 사용 가능한 skill, MCP, 플러그인, 커넥터, 프로젝트 파일에서 최적의 조합을 선택하세요.',
  ...
  'chat.designToolbox.prompt.autoMatchStep2': '2. 위의 전체 리소스 인덱스를 검색하고 매칭하세요. 디자인 툴박스 추천만 사용하지 말고, 유용할 때 skill, MCP, 플러그인, 커넥터, 프로젝트 파일을 결합하세요.',
  ...
  'chat.designToolbox.prompt.fileResource': '이 프로젝트 파일을 현재 대상 또는 참조 에셋으로 사용하여 다음 단계를 완료하세요. 다른 파일과 비교해야 하는 경우, 모든 프로젝트 파일에서 계속 검색하세요.',
  'chat.designToolbox.prompt.resourceIndex': '전역 리소스 인덱스: skill({skills}), 플러그인({plugins}), MCP(활성화 {mcpEnabled}개 / 템플릿 {mcpTemplates}개), 커넥터(연결 {connectors}개), 프로젝트 파일({files}).',
  ...
  'chat.designToolbox.prompt.referenceDesignFiles': '참조 파일',
  ...
  'chat.mentionTabFiles': '파일',
  'chat.mentionNoResults': '“{query}”에 대한 결과가 없습니다.',
  'chat.mentionSearchPrompt': '파일, 탭, 플러그인, skill, MCP 서버, 커넥터를 검색하세요.',
  ...
  'preview.replicateContent': '이 디자인으로 시작',
  'preview.replicateContentDesc': '입력창에 예시 문구를 넣습니다(선택). 템플릿 적용만 하려면 「사용」을 누르세요.',
  ...
  'workspace.openFromDesignFiles': '프로젝트 파일에서',
  ...
  'fileViewer.draw': '그리기',
  'fileViewer.mark': '표시',
  'fileViewer.markTooltip': '영역을 표시하고 메모와 함께 채팅으로 보냅니다',
  ...
  'manualEdit.positionPromoteOnDrag': '드래그하면 레이아웃 자리에서 이동합니다.',
  'manualEdit.positionPromoteStickyOnDrag': '드래그하면 sticky를 absolute로 풀어 이동합니다.',
  ...
  'fileRevision.history.title': '편집 기록',
  'fileRevision.history.empty': '저장된 편집이 없습니다.',
  'fileRevision.history.restore': '복원',
  ...
  'fileRevision.undo.unavailableTooltip': '파일이 예기치 않게 변경되어 실행 취소와 다시 실행을 사용할 수 없습니다.',
  ...
  'fileViewer.previousSlide': '이전 페이지',
  'fileViewer.nextSlide': '다음 페이지',
  'fileViewer.slideNavAria': '페이지 이동',
  'fileViewer.moveSlideEarlier': '페이지 앞으로',
  'fileViewer.moveSlideLater': '페이지 뒤로',
  'fileViewer.deleteSlide': '페이지 삭제',
  'fileViewer.insertBlankSlide': '빈 페이지 추가',
  ...
  'fileViewer.exportPdf': 'PDF로 다운로드',
  'fileViewer.exportPdfAllSlides': 'PDF로 다운로드 (모든 슬라이드)',
  'fileViewer.exportPptxBusy': '현재 작업이 끝날 때까지 기다려 주세요.',
  'fileViewer.exportPptxHint': '현재 슬라이드를 PPTX 파일로 다운로드합니다.',
  'fileViewer.exportPptxNa': '이곳에서는 PPTX 다운로드를 할 수 없습니다.',
  'fileViewer.exportZip': '.zip으로 다운로드',
  'fileViewer.exportHtml': '독립 실행형 HTML로 다운로드',
  ...
  'fileViewer.exportPptxRequested': 'PPTX 다운로드를 시작했습니다',
  ...
  'teamver.embed.teamverAppTitle': 'Teamver 앱 열기 (슬라이드에서 나가기)',
  'teamver.embed.sessionLoading': 'Teamver 세션 확인 중…',
  'teamver.embed.signIn': 'Teamver 로그인',
  'teamver.embed.designDisabled': '슬라이드 사용 불가',
  'teamver.backgroundRuns.titleOne': '백그라운드에서 실행 중',
  'teamver.backgroundRuns.titleMany': '{n}개 프로젝트에서 실행 중',
  'teamver.backgroundRuns.running': '실행 중',
  'teamver.backgroundRuns.queued': '대기 중',
  'teamver.backgroundRuns.andMore': '외 {n}개',
  'teamver.backgroundRuns.open': '열기',
  'teamver.runRecovery.title': '백그라운드 작업 재연결',
  'teamver.runRecovery.connecting': '이전 작업에 다시 연결하는 중…',
  'teamver.runRecovery.connectingWithSaved': '이전 작업에 다시 연결하는 중… (저장된 내용 {n}자)',
  'teamver.runRecovery.live': '실행 중 · 실시간 출력 수신 중',
  'teamver.runRecovery.liveWithSaved': '실행 중 · 저장된 {n}자 + 새 출력 수신 중',
  'teamver.runRecovery.queued': '대기 중 · 곧 시작됩니다',
  'teamver.publish.chipLabel': 'Drive v{version}',
  'teamver.publish.chipTitle': 'Drive v{version} ({kind}) — {filename}',
  'teamver.driveImport.attachFromMenu': '드라이브에서 가져오기',
  'teamver.driveImport.loadMore': '더 보기',
  'teamver.driveImport.attachCount': '{n}개 첨부',
  'teamver.driveImport.selectedCount': '{n}개 선택됨 (최대 {max}개)',
  'teamver.driveImport.pickHint': '클릭해 선택 · 더블클릭 또는 첨부 버튼으로 적용',
  'teamver.driveImport.maxPickReached': '한 번에 최대 {max}개까지 선택할 수 있습니다.',
  'teamver.driveImport.alreadyAttached': '이미 첨부됨',
  'teamver.driveImport.unsupportedForSlide': '슬라이드에서 지원하지 않음',
  'teamver.driveImport.searchMayHaveMore': '더 많은 결과가 있을 수 있습니다',
  'teamver.driveImport.partialSuccess': 'Drive에서 {n}개 파일을 첨부했습니다',
  'teamver.driveImport.partialFailedLead': '{n}개 파일을 가져오지 못했습니다:',
  'teamver.driveImport.done': '완료',
  'teamver.driveImport.retryFailed': '실패 항목 다시 시도 ({n})',
  'teamver.driveImport.error.unsupported_drive_import_file_type': '슬라이드 첨부에 지원하지 않는 파일 형식입니다',
  'teamver.driveImport.error.drive_download_failed': 'Teamver Drive에서 다운로드할 수 없습니다',
  'teamver.driveImport.error.od_daemon_import_failed': '슬라이드 프로젝트에 저장할 수 없습니다',
  'teamver.driveImport.error.invalid_filename': '파일 이름이 올바르지 않습니다',
  'teamver.driveImport.error.drive_import_failed': 'Drive 가져오기에 실패했습니다',
  'teamver.homeCreate.title': 'Teamver Slide',
  'teamver.homeCreate.lead': '내용과 템플릿만 고르면 덱을 시작합니다.',
  'teamver.homeCreate.cta': '새 슬라이드',
  'teamver.homeCreate.modalTitle': '새 슬라이드',
  'teamver.homeCreate.stepperAria': '슬라이드 생성 단계',
  'teamver.homeCreate.stepContent': '내용',
  'teamver.homeCreate.stepTemplate': '템플릿',
  'teamver.homeCreate.attachTitle': '참고 자료 (선택)',
  'teamver.homeCreate.upload': '파일 업로드',
  'teamver.homeCreate.drive': '드라이브에서 가져오기',
  'teamver.homeCreate.driveUnavailable': 'Teamver 작업공간을 먼저 선택한 뒤 다시 시도하세요.',
  ...
  'teamver.canvasSlideLaunch.stepDocument': '가져올 문서',
  'teamver.canvasSlideLaunch.stepPrompt': '프롬프트',
  'teamver.canvasSlideLaunch.stepTemplate': '템플릿',
  'teamver.canvasSlideLaunch.stepOptionalBadge': '선택',
  'teamver.canvasSlideLaunch.templateLead': '바꾸지 않으면 선택된 기본 템플릿으로 생성합니다.',
  'teamver.canvasSlideLaunch.promptLabel': '슬라이드 생성 지시',
  'teamver.canvasSlideLaunch.promptLead': '발표 목적, 톤, 강조할 섹션, 슬라이드 수 등을 적어 주세요. 비워 두면 문서 내용만으로 생성합니다.',
  'teamver.canvasSlideLaunch.promptPlaceholder': '예: 첫 수업용 발표, 8장 내외, 학생 대상으로 친근한 톤. 커리큘럼과 과제 안내를 강조.',
  'teamver.canvasSlideLaunch.promptEmptySummary': '지시 없음 (문서 기준)',
  'teamver.canvasSlideLaunch.quickSettingsTitle': '빠른 설정',
  'teamver.canvasSlideLaunch.quickAudience': '대상',
  'teamver.canvasSlideLaunch.quickAudienceAuto': '자동',
  'teamver.canvasSlideLaunch.quickAudienceInternal': '내부 보고',
  'teamver.canvasSlideLaunch.quickAudienceClient': '고객 제안',
  'teamver.canvasSlideLaunch.quickAudienceEducation': '교육',
  'teamver.canvasSlideLaunch.quickAudienceBusiness': '사업/투자',
  'teamver.canvasSlideLaunch.quickLength': '길이',
  'teamver.canvasSlideLaunch.quickLengthAuto': '자동',
  'teamver.canvasSlideLaunch.quickLengthShort': '짧게 · 5–6장',
  'teamver.canvasSlideLaunch.quickLengthStandard': '보통 · 8–10장',
  'teamver.canvasSlideLaunch.quickLengthDetailed': '자세히 · 12–15장',
  'teamver.canvasSlideLaunch.quickTransform': '변환',
  'teamver.canvasSlideLaunch.quickTransformPresentation': '발표용 재구성',
  'teamver.canvasSlideLaunch.quickTransformFaithful': '원문 충실',
  'teamver.canvasSlideLaunch.quickTransformSummary': '요약 중심',
  'teamver.canvasSlideLaunch.quickTone': '톤',
  'teamver.canvasSlideLaunch.quickToneAuto': '자동',
  'teamver.canvasSlideLaunch.quickToneProfessional': '전문적',
  'teamver.canvasSlideLaunch.quickToneModern': '모던',
  'teamver.canvasSlideLaunch.quickToneFriendly': '친근',
  'teamver.canvasSlideLaunch.quickToneImpact': '임팩트',
  'teamver.canvasSlideLaunch.nextPrompt': '다음: 프롬프트',
  'teamver.canvasSlideLaunch.nextTemplate': '다음: 템플릿',
  'teamver.canvasSlideLaunch.templateFallback': '기본 슬라이드 템플릿',
  'teamver.canvasSlideLaunch.footerTemplate': '템플릿: {name}',
  ...
  'teamver.canvasSlideLaunch.sections': '섹션 {count}개',
  'teamver.canvasSlideLaunch.updated': '수정 {when}',
  'teamver.canvasSlideLaunch.confirm': '슬라이드 만들기',
  'teamver.canvasSlideLaunch.close': '닫기',
  'teamver.canvasSlideLaunch.back': '이전',
  'teamver.canvasSlideLaunch.next': '다음',
  'teamver.canvasSlideLaunch.stepperLabel': '슬라이드 만들기 단계',
  'teamver.canvasSlideLaunch.cancel': '취소',
  'teamver.canvasSlideLaunch.working': '시작 중…',
  'teamver.canvasSlideLaunch.retry': '다시 시도',
  'teamver.about.panelHint': '정보',
  'teamver.about.openSourceTitle': '오픈소스 소프트웨어',
  'teamver.about.openSourceIntro': 'teamver Slide은 다음 오픈소스 구성요소를 포함합니다.',
