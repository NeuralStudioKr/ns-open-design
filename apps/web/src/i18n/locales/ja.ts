...
export const ja: Dict = {
  ...
  'chat.conversationsNoMatch': '一致する会話がありません。',
  ...
  'chat.startHintComposerOnly': '下の入力欄に作りたい内容を入力してください。',
  ...
  'chat.plusMenu.searchPlugins': 'プラグインを検索…',
  'chat.plusMenu.searchMcp': 'MCPを検索…',
  'chat.plusMenu.searchSkills': 'スキルを検索…',
  'chat.plusMenu.pluginSourceAria': 'プラグインのソース',
  'chat.plusMenu.pluginsMine': 'マイプラグイン',
  'chat.plusMenu.mcpTemplates': 'テンプレート',
  ...
  'preview.replicateContent': 'このデザインで始める',
  'preview.replicateContentDesc': 'サンプルプロンプトを読み込み、プレビューに近づけます',
  ...
  'workspace.designFiles': 'プロジェクトファイル',
  ...
  'workspace.designFilesLink': 'プロジェクトファイル',
  ...
  'manualEdit.positionPromoteOnDrag': 'ドラッグするとレイアウト上の位置をずらして移動できます。',
  'manualEdit.positionPromoteStickyOnDrag': 'ドラッグすると sticky を absolute に切り替えて移動できます。',
  ...
  'fileRevision.history.title': '編集履歴',
  'fileRevision.history.empty': '保存された編集はまだありません。',
  'fileRevision.history.restore': '復元',
  ...
  'teamver.canvasSlideLaunch.stepOptionalBadge': '省略可',
  ...
  'teamver.canvasSlideLaunch.sections': 'セクション {count}件',
  'teamver.canvasSlideLaunch.updated': '更新 {when}',
  'teamver.canvasSlideLaunch.confirm': 'スライドを作成',
