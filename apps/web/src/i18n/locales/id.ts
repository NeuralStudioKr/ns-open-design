...
export const id: Dict = {
  ...
  'chat.conversationsNoMatch': 'Tidak ada percakapan yang cocok.',
  ...
  'chat.startHintComposerOnly': 'Jelaskan yang ingin dibuat di kolom di bawah.',
  ...
  'chat.plusMenu.searchPlugins': 'Cari plugin…',
  'chat.plusMenu.searchMcp': 'Cari MCP…',
  'chat.plusMenu.searchSkills': 'Cari skill…',
  'chat.plusMenu.pluginSourceAria': 'Sumber plugin',
  'chat.plusMenu.pluginsMine': 'Plugin saya',
  'chat.plusMenu.mcpTemplates': 'Template',
  ...
  'preview.replicateContent': 'Mulai dengan desain ini',
  'preview.replicateContentDesc': 'Muat prompt contoh agar mendekati pratinjau',
  ...
  'workspace.designFiles': 'File proyek',
  ...
  'workspace.designFilesLink': 'File proyek',
  ...
  'manualEdit.positionPromoteOnDrag': 'Seret untuk menggeser elemen dalam flow (position: relative).',
  'manualEdit.positionPromoteStickyOnDrag': 'Seret untuk melepaskan elemen sticky ini (position: absolute).',
  ...
  'nextStep.collapse': 'Ciutkan',
  'nextStep.expand': 'Perluas',
  ...
  'teamver.canvasSlideLaunch.stepOptionalBadge': 'opsional',
