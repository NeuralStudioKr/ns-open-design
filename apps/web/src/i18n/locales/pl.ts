...
export const pl: Dict = {
  ...
  'chat.conversationsNoMatch': 'Brak pasujących rozmów.',
  ...
  'chat.startHintComposerOnly': 'Opisz poniżej, co chcesz wygenerować.',
  ...
  'chat.plusMenu.searchPlugins': 'Szukaj wtyczek…',
  'chat.plusMenu.searchMcp': 'Szukaj MCP…',
  'chat.plusMenu.searchSkills': 'Szukaj umiejętności…',
  'chat.plusMenu.pluginSourceAria': 'Źródło wtyczek',
  'chat.plusMenu.pluginsMine': 'Moje wtyczki',
  'chat.plusMenu.mcpTemplates': 'Szablony',
  ...
  'chat.mentionSectionFiles': 'Pliki',
  ...
  'preview.replicateContent': 'Zacznij od tego designu',
  'preview.replicateContentDesc': 'Załaduj przykładowy prompt, aby zbliżyć się do podglądu',
  ...
  'designFiles.sectionSupporting': 'Pliki pomocnicze',
  ...
  'manualEdit.positionMoveRequiresAbsolute': 'Przeciąganie pozycji wymaga absolute lub fixed.',
  'manualEdit.positionPromoteOnDrag': 'Przeciągnij, aby przesunąć element w flow (position: relative).',
  'manualEdit.positionPromoteStickyOnDrag': 'Przeciągnij, aby uwolnić ten element sticky (position: absolute).',
