...
export const fa: Dict = {
  ...
  'chat.conversationsSearchPlaceholder': 'جستجوی مکالمات',
  'chat.conversationsNoMatch': 'مکالمهٔ منطبقی نیست.',
  ...
  'chat.startHintComposerOnly': 'آنچه می‌خواهید بسازید را در کادر زیر بنویسید.',
  ...
  'chat.plusMenu.searchPlugins': 'جستجوی پلاگین…',
  'chat.plusMenu.searchMcp': 'جستجوی MCP…',
  'chat.plusMenu.searchSkills': 'جستجوی مهارت…',
  'chat.plusMenu.pluginSourceAria': 'منبع پلاگین',
  'chat.plusMenu.pluginsMine': 'پلاگین‌های من',
  'chat.plusMenu.mcpTemplates': 'قالب‌ها',
  ...
  'chat.mentionSectionFiles': 'فایل‌ها',
  ...
  'preview.replicateContent': 'شروع با این طراحی',
  'preview.replicateContentDesc': 'پرامپت نمونه را بارگذاری کنید تا به پیش‌نمایش نزدیک شود',
  ...
  'workspace.designFiles': 'فایل‌های پروژه',
  ...
  'workspace.designFilesLink': 'فایل‌های پروژه',
  ...
  'designFiles.title': 'فایل‌های پروژه',
  ...
  'manualEdit.positionMoveRequiresAbsolute': 'جابه\u200cجایی با کشیدن فقط برای absolute/fixed است.',
  'manualEdit.positionPromoteOnDrag': 'برای جابه‌جایی عنصر در جریان بکشید (position: relative).',
  'manualEdit.positionPromoteStickyOnDrag': 'برای آزاد کردن این عنصر sticky بکشید (position: absolute).',
  ...
  'nextStep.collapse': 'جمع کردن',
  'nextStep.expand': 'باز کردن',
  'nextStep.more': 'بیشتر',
  ...
  'teamver.canvasSlideLaunch.stepOptionalBadge': 'اختیاری',
