...
export const ru: Dict = {
  ...
  'chat.conversationsSearchPlaceholder': 'Поиск разговоров',
  'chat.conversationsNoMatch': 'Нет подходящих разговоров.',
  ...
  'chat.startHintComposerOnly': 'Опишите, что хотите сгенерировать, в поле ниже.',
  ...
  'chat.plusMenu.searchPlugins': 'Поиск плагинов…',
  'chat.plusMenu.searchMcp': 'Поиск MCP…',
  'chat.plusMenu.searchSkills': 'Поиск навыков…',
  'chat.plusMenu.pluginSourceAria': 'Источник плагинов',
  'chat.plusMenu.pluginsMine': 'Мои плагины',
  'chat.plusMenu.mcpTemplates': 'Шаблоны',
  ...
  'chat.mentionSectionFiles': 'Файлы',
  ...
  'preview.replicateContent': 'Начать с этого дизайна',
  'preview.replicateContentDesc': 'Загрузить пример промпта, чтобы приблизиться к превью',
  ...
  'workspace.designFiles': 'Файлы проекта',
  ...
  'workspace.designFilesLink': 'Файлы проекта',
  ...
  'designFiles.title': 'Файлы проекта',
  ...
  'manualEdit.positionPromoteOnDrag': 'Перетащите, чтобы сместить элемент в потоке (position: relative).',
  'manualEdit.positionPromoteStickyOnDrag': 'Перетащите, чтобы освободить sticky-элемент (position: absolute).',
  ...
  'teamver.canvasSlideLaunch.stepOptionalBadge': 'Необязательно',
