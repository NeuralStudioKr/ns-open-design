...
export const zhTW: Dict = {
  ...
  'homeWorkingDir.hint': '讓 Agent 可讀取該本機目錄（不會匯入專案檔案）',
  ...
  'chat.conversationsNoMatch': '沒有符合的對話。',
  ...
  'chat.startHintComposerOnly': '請在下方輸入框描述你想生成的內容。',
  ...
  'chat.plusMenu.searchPlugins': '搜尋外掛…',
  'chat.plusMenu.searchMcp': '搜尋 MCP…',
  'chat.plusMenu.searchSkills': '搜尋技能…',
  'chat.plusMenu.pluginSourceAria': '外掛來源',
  'chat.plusMenu.pluginsMine': '我的外掛',
  'chat.plusMenu.mcpTemplates': '範本',
  ...
  'preview.replicateContent': '以此設計開始',
  'preview.replicateContentDesc': '載入範例提示詞，產生與預覽相近的內容',
  ...
  'workspace.designFilesLink': '專案檔案',
  ...
  'manualEdit.positionPromoteOnDrag': '拖曳可在流式版面中偏移此元素。',
  'manualEdit.positionPromoteStickyOnDrag': '拖曳可將此 sticky 元素設為 absolute 並移動。',
  ...
  'manualEdit.undo': '復原',
  'manualEdit.redo': '重做',
  'fileRevision.history.title': '編輯記錄',
  'fileRevision.history.empty': '尚無已儲存的編輯。',
  'fileRevision.history.restore': '還原',
  ...
  'fileRevision.history.retentionPending': '正在清理較早的編輯記錄，清單將很快更新。',
  ...
  'fileViewer.exportPdfBrowserPrintFallback': '伺服器 PDF 渲染延遲。請在瀏覽器列印對話框選擇「另存為 PDF」以下載檔案。',
  ...
  'teamver.canvasSlideLaunch.stepOptionalBadge': '可選',
