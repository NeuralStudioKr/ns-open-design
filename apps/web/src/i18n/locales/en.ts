...
export const en: Dict = {
  ...
  'homeHero.placeholderTemplate': 'Describe your goal — the {title} template sets style and structure',
  'homeHero.presetSelectedHint': 'Style and reference come from {title}. Write your brief in the box above.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable plugin and add it to My plugins.',
  ...
  'homeWorkingDir.hint': 'Let the agent read this local folder (not imported into Project files)',
  ...
  'designSystemPicker.previewUnavailable': 'This design system has no separate preview page.',
  'designSystemPicker.previewLoadFailed': 'Preview did not load. Use the swatches and summary above, or try again in a moment.',
  'designSystemPicker.previewRetry': 'Try again',
  ...
  'pluginsHome.emptyFilteredSearch': 'No plugins match your search.',
  ...
  'chat.annotationSentWithoutScreenshot': 'Could not capture preview — only your note was sent. Try Comment mode for element-specific edits.',
  ...
  'chat.conversationsNoMatch': 'No conversations match.',
  ...
  'chat.startHintComposerOnly': 'Describe what you want to generate in the composer below.',
  ...
  'chat.designArtifactsShowMore': 'Show {count} more files',
  ...
  'chat.designToolbox.searchPlaceholder': 'Search skills / MCP / plugins / connectors / files...',
  'chat.plusMenu.searchPlugins': 'Search plugins…',
  'chat.plusMenu.searchMcp': 'Search MCP…',
  'chat.plusMenu.searchSkills': 'Search skills…',
  'chat.plusMenu.pluginSourceAria': 'Plugin source',
  'chat.plusMenu.pluginsMine': 'My plugins',
  'chat.plusMenu.mcpTemplates': 'Templates',
  ...
  'chat.designToolbox.kind.designFile': 'File',
  'chat.designToolbox.context.browser': 'Browser',
  'chat.designToolbox.context.designFiles': 'Files',
  ...
  'chat.designToolbox.prompt.contextGeneric': 'Current target: the currently open HTML / project file / web element.',
  ...
  'chat.designToolbox.prompt.noSkill': 'If no specific skill matched, first choose the best combination from available skills, MCP, plugins, connectors, and project files.',
  ...
  'chat.designToolbox.prompt.autoMatchStep2': '2. Search and match the full resource index above. Do not only use design toolbox recommendations; combine skills, MCP, plugins, connectors, and project files when useful.',
  ...
  'chat.designToolbox.prompt.fileResource': 'Use this project file as the current target or reference asset and complete the next step from it. If other files need comparison, continue searching across all project files.',
  'chat.designToolbox.prompt.resourceIndex': 'Global resource index: skills({skills}), plugins({plugins}), MCP({mcpEnabled} enabled / {mcpTemplates} templates), connectors({connectors} connected), project files({files}).',
  ...
  'chat.designToolbox.prompt.referenceDesignFiles': 'Reference files',
  ...
  'chat.mentionTabFiles': 'Files',
  'chat.mentionNoResults': 'No results for “{query}”.',
  'chat.mentionSearchPrompt': 'Search files, tabs, plugins, skills, MCP servers, and connectors.',
  ...
  'chat.mentionSectionFiles': 'Files',
  ...
  'preview.replicateContent': 'Start with this design',
  'preview.replicateContentDesc': 'Load the example prompt to match the preview',
  ...
  'workspace.designFiles': 'Project files',
  ...
  'workspace.designFilesLink': 'Project files',
  ...
  'fileViewer.markTooltip': 'Mark an area and send it to the chat with a note',
  ...
  'manualEdit.positionPromoteOnDrag': 'Drag to offset this element (keeps it in flow).',
  'manualEdit.positionPromoteStickyOnDrag': 'Drag to free this sticky element (sets position: absolute).',
  ...
  'fileRevision.history.title': 'Edit history',
  'fileRevision.history.empty': 'No saved edits yet.',
  'fileRevision.history.restore': 'Restore',
  ...
  'fileViewer.previousSlide': 'Previous page',
  'fileViewer.nextSlide': 'Next page',
  'fileViewer.slideNavAria': 'Page navigation',
  'fileViewer.moveSlideEarlier': 'Move page earlier',
  'fileViewer.moveSlideLater': 'Move page later',
  'fileViewer.deleteSlide': 'Delete page',
  'fileViewer.insertBlankSlide': 'Insert blank page',
  ...
  'fileViewer.exportPptxHint': 'Download the current slides as a PPTX file.',
  ...
  'fileViewer.exportPptxRequested': 'PPTX download started',
  ...
  'settings.skillsHint': 'Functional skills the agent can invoke during a task',
  ...
  'teamver.embed.teamverAppTitle': 'Open the Teamver app (leave Slide)',
  'teamver.embed.sessionLoading': 'Checking Teamver session…',
  'teamver.embed.signIn': 'Sign in to Teamver',
  'teamver.embed.designDisabled': 'Slide unavailable',
  'teamver.backgroundRuns.titleOne': 'Running in the background',
  'teamver.backgroundRuns.titleMany': '{n} projects running',
  'teamver.backgroundRuns.running': 'Running',
  'teamver.backgroundRuns.queued': 'Queued',
  'teamver.backgroundRuns.andMore': '+{n} more',
  'teamver.backgroundRuns.open': 'Open',
  'teamver.runRecovery.title': 'Reconnecting background work',
  'teamver.runRecovery.connecting': 'Reconnecting to your in-progress run…',
  'teamver.runRecovery.connectingWithSaved': 'Reconnecting… ({n} characters saved so far)',
  'teamver.runRecovery.live': 'Running · receiving live output',
  'teamver.runRecovery.liveWithSaved': 'Running · {n} saved characters + new output',
  'teamver.runRecovery.queued': 'Queued · starting soon',
  'teamver.publish.chipLabel': 'Drive v{version}',
  'teamver.publish.chipTitle': 'Drive v{version} ({kind}) — {filename}',
  'teamver.driveImport.attachFromMenu': 'Import from Drive',
  'teamver.driveImport.loadMore': 'Load more',
  'teamver.driveImport.attachCount': 'Attach {n}',
  'teamver.driveImport.selectedCount': '{n} selected (max {max})',
  'teamver.driveImport.pickHint': 'Click to select · double-click or Attach to apply',
  'teamver.driveImport.maxPickReached': 'You can select up to {max} files at once.',
  'teamver.driveImport.alreadyAttached': 'Already attached',
  'teamver.driveImport.unsupportedForSlide': 'Not supported for slides',
  'teamver.driveImport.searchMayHaveMore': 'More results may exist',
  'teamver.driveImport.partialSuccess': '{n} file(s) attached from Drive',
  'teamver.driveImport.partialFailedLead': '{n} file(s) could not be imported:',
  'teamver.driveImport.done': 'Done',
  'teamver.driveImport.retryFailed': 'Retry failed ({n})',
  'teamver.driveImport.error.unsupported_drive_import_file_type': 'File type is not supported for slide attachments',
  'teamver.driveImport.error.drive_download_failed': 'Could not download from Teamver Drive',
  'teamver.driveImport.error.od_daemon_import_failed': 'Could not save into the Slide project',
  ...
  'teamver.homeCreate.title': 'Teamver Slide',
  'teamver.homeCreate.lead': 'Add a brief and a template — then create your deck.',
  'teamver.homeCreate.cta': 'New slide',
  'teamver.homeCreate.modalTitle': 'New slide',
  'teamver.homeCreate.stepperAria': 'Slide creation steps',
  'teamver.homeCreate.stepContent': 'Content',
  'teamver.homeCreate.stepTemplate': 'Template',
  'teamver.homeCreate.attachTitle': 'Reference files (optional)',
  'teamver.homeCreate.upload': 'Upload files',
  'teamver.homeCreate.drive': 'Import from Drive',
  'teamver.homeCreate.driveUnavailable': 'Select a Teamver workspace first, then try again.',
  ...
  'teamver.canvasSlideLaunch.stepTemplate': 'Template',
  'teamver.canvasSlideLaunch.stepOptionalBadge': 'Optional',
  ...
  'teamver.canvasSlideLaunch.promptEmptySummary': 'No extra instructions (document only)',
  'teamver.canvasSlideLaunch.quickSettingsTitle': 'Quick settings',
  'teamver.canvasSlideLaunch.quickAudience': 'Audience',
  'teamver.canvasSlideLaunch.quickAudienceAuto': 'Auto',
  'teamver.canvasSlideLaunch.quickAudienceInternal': 'Internal report',
  'teamver.canvasSlideLaunch.quickAudienceClient': 'Client proposal',
  'teamver.canvasSlideLaunch.quickAudienceEducation': 'Education',
  'teamver.canvasSlideLaunch.quickAudienceBusiness': 'Business/investor',
  'teamver.canvasSlideLaunch.quickLength': 'Length',
  'teamver.canvasSlideLaunch.quickLengthAuto': 'Auto',
  'teamver.canvasSlideLaunch.quickLengthShort': 'Short · 5–6',
  'teamver.canvasSlideLaunch.quickLengthStandard': 'Standard · 8–10',
  'teamver.canvasSlideLaunch.quickLengthDetailed': 'Detailed · 12–15',
  'teamver.canvasSlideLaunch.quickTransform': 'Transform',
  'teamver.canvasSlideLaunch.quickTransformPresentation': 'Presentation rebuild',
  'teamver.canvasSlideLaunch.quickTransformFaithful': 'Source faithful',
  'teamver.canvasSlideLaunch.quickTransformSummary': 'Summary first',
  'teamver.canvasSlideLaunch.quickTone': 'Tone',
  'teamver.canvasSlideLaunch.quickToneAuto': 'Auto',
  'teamver.canvasSlideLaunch.quickToneProfessional': 'Professional',
  'teamver.canvasSlideLaunch.quickToneModern': 'Modern',
  'teamver.canvasSlideLaunch.quickToneFriendly': 'Friendly',
  'teamver.canvasSlideLaunch.quickToneImpact': 'Impact',
  'teamver.canvasSlideLaunch.nextPrompt': 'Next: Prompt',
  'teamver.canvasSlideLaunch.nextTemplate': 'Next: Template',
  'teamver.canvasSlideLaunch.templateFallback': 'Default slide template',
  'teamver.canvasSlideLaunch.footerTemplate': 'Template: {name}',
  'teamver.canvasSlideLaunch.badge': 'Canvas → Slide',
  'teamver.canvasSlideLaunch.sourceLabel': 'Document',
  'teamver.canvasSlideLaunch.untitled': 'Untitled document',
  'teamver.canvasSlideLaunch.sections': '{count} sections',
  'teamver.canvasSlideLaunch.updated': 'Updated {when}',
  'teamver.canvasSlideLaunch.confirm': 'Create slides',
  'teamver.canvasSlideLaunch.close': 'Close',
  'teamver.canvasSlideLaunch.back': 'Back',
  'teamver.canvasSlideLaunch.next': 'Next',
  'teamver.canvasSlideLaunch.stepperLabel': 'Create slides steps',
