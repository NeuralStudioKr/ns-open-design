...
export const en: Dict = {
  ...
  'teamver.embed.designHome': 'Design home',
  'teamver.embed.designHomeTitle': 'Back to Design — projects and new decks',
  'teamver.embed.teamverApp': 'Teamver app',
  'teamver.embed.teamverAppTitle': 'Open the Teamver app (leave Design)',
  'teamver.embed.sessionLoading': 'Checking Teamver session…',
  'teamver.embed.signIn': 'Sign in to Teamver',
  'teamver.embed.designDisabled': 'Design unavailable',
  ...
  'teamver.driveImport.error.od_daemon_import_failed': 'Could not save into the Design project',
