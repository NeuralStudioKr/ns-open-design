...
export const en: Dict = {
  ...
  'teamver.canvasSlideLaunch.description': 'Import the Canvas source into this project and start slide generation in one step.',
  'teamver.canvasSlideLaunch.sourceLabel': 'Canvas source',
