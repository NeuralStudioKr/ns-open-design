...
const AUTO_CONTINUE_MOTIF_SVG_DUMP_ABANDON =
  ...
  + 'Restart BODY-FIRST with `<h1>` then lead `<p>`, THEN THIS kit\'s Motif vocabulary (capped sprites AFTER title and/or this kit\'s named deco CSS classes). Never invent generic CSS circles or import another template\'s ornaments.';
