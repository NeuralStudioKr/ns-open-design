...
export function wrapSelectedDeckTemplateSkillBody(
  ...
  return [
    ...
    'text/content. Keep scaffold CSS/SVG/classes when you can finish the deck.',
    'The **Template visual kit** (when present) remains the mandatory token/motif',
    'checklist and the valid fallback if scaffold copy would truncate.',
    '',
