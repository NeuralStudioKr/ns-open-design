...
interface Props {
  ...
  onOpenProject: (id: string, options?: { fileName?: string | null; conversationId?: string | null }) => void;
...
export function EntryShell({
  ...
  function handlePluginLoopSubmit(payload: PluginLoopSubmit) {
    ...
    const metadata: ProjectMetadata = {
      ...
      ...(!hideLocalWorkspaceControls && payload.workingDir
        ? { linkedDirs: [payload.workingDir] }
        : {}),
