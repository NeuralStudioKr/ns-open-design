...
class AiModelTokenUsage(BaseModel):
    ...
    provider_reported_model: Mapped[str | None] = mapped_column(String, nullable=True)
    api_protocol: Mapped[str | None] = mapped_column(String, nullable=True)
    credits_amount_t: Mapped[int | None] = mapped_column(Integer, nullable=True)
