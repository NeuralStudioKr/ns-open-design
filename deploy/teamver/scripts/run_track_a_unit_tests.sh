...
bash "$ROOT/scripts/test_print_staging_s3_env.sh"
bash "$ROOT/scripts/test_apply_production_s3_env.sh"
bash "$ROOT/scripts/test_print_production_s3_env.sh"
bash "$ROOT/scripts/test_run_s3_integration_test.sh"
bash "$ROOT/scripts/test_smoke_design_storage_default.sh"
bash "$ROOT/scripts/test_smoke_design_idempotent_post.sh"
...
bash "$ROOT/scripts/test_check_plugin_preview_nginx_applied.sh"
bash "$ROOT/scripts/test_run_staging_track_a_e2e.sh"
bash "$ROOT/scripts/test_print_staging_track_a_e2e_env.sh"
bash "$ROOT/scripts/test_print_production_track_a_e2e_env.sh"
...
if [[ "$SKIP_WEB" -eq 0 ]]; then
  ...
  (
    ...
    npm test -- tests/teamver-publish-drive.test.ts \
      ...
      tests/teamver-active-workspace.test.ts \
