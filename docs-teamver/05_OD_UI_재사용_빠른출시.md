...
**관련:** [04_구현_우선순위](./04_구현_우선순위.md) · [07_VM_배포_인프라](./07_VM_배포_인프라.md) · [01_통합_아키텍처](./01_통합_아키텍처.md) · [open-design-index](./open-design-index.md)
...
> 커스텀 design-app FE·run/job wrapper BE는 **출시 이후** 단계로 미룬다.
...
| 순서 | 항목 | 문서 |
|------|------|------|
| 1 | Drive에 export 결과 자동 업로드 | [03_키_저장소_Drive_DB](./03_키_저장소_Drive_DB.md) |
| 2 | usage·과금 hook | `app-sdk` |
| 3 | wrapper BE + job queue (부하·멀티테넌트) | [02_design-app_daemon_연동](./02_design-app_daemon_연동.md) |
