...
=======
| 2026-08-21 | §0.81 — Motif hang SSOT + neutralize harden. Accent/:after/arr/rsvp-stamp lexicon · vw offset units · preview remmerge uses deckHtmlHasMotifOutsideCanvasHang · no flex-force / bare [data-slide] · overflow:visible teaching · cache v45. |
>>>>>>> 99c1bdf3c (fix(deck): Motif hang SSOT, neutralize harden, overflow teaching (§0.81))
