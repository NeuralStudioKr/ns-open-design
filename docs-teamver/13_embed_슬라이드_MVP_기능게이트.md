...
| Sh-8 | `FileViewer` chrome **download** menu — PDF / Image / HTML / Markdown / ZIP / Save as template / **PPTX** | 사용자 OS 다운로드 | 낮음 (로컬) | **유지** | `VITE_TEAMVER_PPTX_EXPORT_ENABLE` (기본 on, `false`로 숨김) |
