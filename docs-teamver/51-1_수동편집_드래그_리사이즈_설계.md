...
| Committing | `flushManualEditStyleSave` 1회. 성공 후 pause 해제. **실패 시 Cancelling과 동일 keyed 롤백** (`stylesBefore`) |
| Cancelling | pending geometry 키 제거 + stylesBefore preview, pause 해제, **POST 없음** |
