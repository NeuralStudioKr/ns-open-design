...
# Open Design — API 키·저장소·DB·Teamver 연동 검토

open-design daemon이 **키를 어디에 두는지**, **산출물(artifacts)과 DB가 어디에 쌓이는지**, Teamver **Drive / 자체 DB**와 어떻게 맞출지 정리합니다.

**관련 문서 (본 레포)**

| 문서 | 내용 |
|------|------|
| [03_open-design_데몬_통신_규격.md](./03_open-design_데몬_통신_규격.md) | HTTP/SSE, export API |
| [02_open-design_packages_개요.md](./02_open-design_packages_개요.md) | `contracts` 등 |
| [01_1_open-design_teamver통합방안_chatgpt.md](./01_1_open-design_teamver통합방안_chatgpt.md) | wrapper·sidecar 권장 |
| [05_teamver-design-app_open-design_daemon_연동_구조.md](./05_teamver-design-app_open-design_daemon_연동_구조.md) | job·worker·daemon 연동 |

**근거 (open-design 업스트림)**

| 주제 | 경로 |
|------|------|
| 설정 파일 개요 | `open-design/docs/architecture.md` §6 |
| 저장 (README 요약) | `open-design/docs/i18n/README.ko.md` |
| Docker·`OD_API_TOKEN` | `open-design/docs/deployment/docker.md`, `deploy/docker-compose.yml` |
| 미디어 키 | `open-design/apps/daemon/src/media-config.ts` |
| 앱 설정·CLI env | `open-design/apps/daemon/src/app-config.ts` |
| SQLite 스키마 | `open-design/apps/daemon/src/db.ts` |
| 프로젝트 파일(artifact) | `open-design/apps/daemon/src/projects.ts` |
| 플러그인 DB | `open-design/apps/daemon/src/plugins/persistence.ts` |
...
4. **Teamver 사용자 JWT를 OD에 넘기지 않음** — IAM은 wrapper에서만 ([01_1](./01_1_open-design_teamver통합방안_chatgpt.md)).
...
전제: [01_1](./01_1_open-design_teamver통합방안_chatgpt.md) — **open-design fork 대량 수정 비권장**, **teamver-design-app wrapper**가 Teamver SDK 사용.
