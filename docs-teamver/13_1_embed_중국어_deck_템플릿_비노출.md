...
`EMBED_HIDDEN_CHINESE_PRIMARY_DECK_TEMPLATE_IDS` (15개 + guizang family) — SSOT: `@open-design/contracts` `embed-chinese-deck-policy.ts`
...
deck-swiss-international # guizang Style B — EN 크롬 + 중국어 본문/KPI
ppt-keynote              # plugin/skill — Keynote 스타일 중국어 제품소개 데모
html-ppt-xhs-white-editorial
html-ppt-presenter-mode  # alias: html-ppt-presenter-mode-reveal
...
|-----------|-------------|
| `example-guizang-ppt` / `guizang-ppt` | `magazine-web-ppt` |
| `example-deck-guizang-editorial` | `deck-guizang-editorial` |
| `example-html-ppt-presenter-mode-reveal` / `html-ppt-presenter-mode-reveal` | `html-ppt-presenter-mode` |
...
| ID | 항목 | 상태 |
|----|------|------|
| S-5c | embed Community + Design templates — 중국어 deck 15개 + guizang family 비노출 | ✅ |
...
1. staging embed Home 커뮤니티 — `Guizang`, `XHS`, `Hermes 사이버`, `Open-Slide 1920 캔버스 덱`, `Swiss International`, `Keynote` 등 카드 미노출
...
| 날짜 | 내용 |
|------|------|
| 2026-07-20 | `deck-swiss-international` 추가, presenter-mode folder alias, plugin `content_locale` 전수 보강 |
