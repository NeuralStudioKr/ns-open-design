...
| 날짜 | 내용 |
|------|------|
| 2026-07-27 | session-probe 401 negative cache (60s) + passive/daemon/focus gates on `isTeamverRuntimeConfigAuthBlocked`; stale embed memory cleared on quiet probe miss. |
