...
| 3 | **결과 HTML/deck 미리보기·Drive publish 완료 동선** | 생성 성공 후 결과 확인·저장을 짧게 만듦 | **✅ loop 398/403/410** — publish menu arm · deploy+last-target focus |
...
| ~~**404**~~ | ✅ **410** | ~~one-click~~ → **deploy 메뉴 + 마지막 target focus** |
