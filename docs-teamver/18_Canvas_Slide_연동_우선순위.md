...
| 3 | **결과 HTML/deck 미리보기·Drive publish 완료 동선** | 생성 성공 후 결과 확인·저장을 짧게 만듦 | **✅ loop 398/403/409** — publish menu arm · one-click publish |
...
| ~~**404**~~ | ✅ **409** | ~~**one-click publish**~~ — 마지막 target 자동 발행 |
