...
| **[50 Undo/Redo 설계](./50_undo_redo_설계.md)** · [50-1 현황](./50-1-구현현황-undo_redo.md) | **수동편집·에이전트 revision undo** |
| **[드래그 리사이즈 00…](./수동편집_드래그_리사이즈/)** | **Manual Edit 박스 핸들 · [00 기획](./수동편집_드래그_리사이즈/00_기획.md) · [00-1 설계](./수동편집_드래그_리사이즈/00-1_설계.md) · [00-2 현황](./수동편집_드래그_리사이즈/00-2_구현현황.md)** |
...
| 50 | **[Undo/Redo 설계](./50_undo_redo_설계.md)** · [50-1 현황](./50-1-구현현황-undo_redo.md) |
| 드래그 리사이즈 | **[00 시리즈](./수동편집_드래그_리사이즈/)** — [기획](./수동편집_드래그_리사이즈/00_기획.md) · [설계](./수동편집_드래그_리사이즈/00-1_설계.md) · [현황](./수동편집_드래그_리사이즈/00-2_구현현황.md) |
