...
// Request: { fileName, deck, title }
// Response 201:
{
  "download": {
    "method": "GET",
    "url": "/api/projects/:id/export/downloads/01JABC…",
...
// → stream from temp file OR 302 to presigned S3
```
...
// POST response when cached:
{
  "download": {
    "method": "GET",
    "url": "https://teamver-design-staging-data.s3.../exports/…?X-Amz-…",
    "filename": "My Deck.pdf",
    "expiresAt": "…"
  },
  "cached": true,
