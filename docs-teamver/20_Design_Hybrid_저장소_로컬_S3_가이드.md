...
| [39_7 scratch·DaemonDb FAQ](./39_7_scratch_DaemonDb_저장층_심층_FAQ.md) | multi-node·Postgres B5 vs scratch·OD scratch 제거 불가 |
...
| 일자 | 내용 |
|------|------|
| 2026-07-08 | [39_7](./39_7_scratch_DaemonDb_저장층_심층_FAQ.md) cross-link — multi-node 저장층 FAQ |
